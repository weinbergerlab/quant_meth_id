...
## Fit a simple poisson regression with just 10 month period
```{r harm_reg1}
...
Winner is Model 2 (10 and 20 month period). Models 2 and 3 have similar AIC score (within 2 points), so we prefer the simpler model
```{r aic}
 AIC(fit1a)
 AIC(fit2a)
 AIC(fit3a)
...
#other series shifted by 3 months
...
##Run wavelets on the series we generated
```{r wave2, echo=TRUE}
